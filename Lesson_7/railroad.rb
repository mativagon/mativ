...
class Railroad
  ...
  def create_coach
    ...
    when 1
      ...
      @railroad_coaches << PassengerCoach.new(coach_number, coach_capacity)
      puts "Вагон #{coach_number} на #{coach_capacity} мест создан."
    when 2
      puts 'Введите номер вагона:'
      coach_number = gets.chomp.to_s
      puts 'Введите вместимость вагона:'
      ...
      @railroad_coaches << CargoCoach.new(coach_number, coach_capacity)
      puts "Вагон #{coach_number} вместимостью #{coach_capacity} м3 создан."
    else
      puts 'Неверный ввод, введите число от 1 до 2!'
    end
  rescue RuntimeError => e
  ...
  def coach_list_by_train
    ...
    train.each_coach do |coach|
      puts "Номер вагона - #{coach.number}, тип вагона - #{coach.type}, " \
      "свободного места - #{coach.free_place}, занятого места - #{coach.used_place}."
    end
  end

  def train_list_by_station
    puts 'Введите название станции:'
    ...
    station.each_train do |train|
      ...
      "количество вагонов - #{train.coaches.size}."
    end
  end
  ...
  def menu
    ...
    puts '12. Занять места или объем в вагоне'
    puts '13. Посмотреть список вагонов у поезда'
    puts '14. Посмотреть список поездов на станции'
    puts '15. Выход'
  end
